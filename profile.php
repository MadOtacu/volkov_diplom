...
<!doctype html>
  ...
  <!-- Bootstrap Bundle JS (jsDelivr CDN) -->
    ...
    <body  >
            ...
            <div class="row">
                <div class="col-md-3 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                        ...
                        <span class="font-weight-bold">Виталий</span>            
                        <span> </span>
                    </div>
                </div>
                <div class="col-md-5 border-right line">
                    <div class="p-3 py-5">
                        ...
                        <div class="mt-5 text-center"><button type="button" onclick="window.location.href = '/grigorievsky_diplom/Index.html';" class="btn btn-dark">Главная</button></div>
                    </div>
                </div>
                <div class="col-md-4 line" style="margin: 45px 0;" >
                    ...
                    <div class="row mt-3">
                            ...
                            <div class="col-md-12"><label class="labels">Статус</label><h4 id="case6" class="form-control" style="margin: 10px 0; border-color: black;"></h4></div>
                    </div>
                </div>
        ...
        <script src="profileLogic.js" type="text/javascript"></script>
    </body>
</html>